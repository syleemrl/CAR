...
base_file="/home/sonic/Projects/CAR/network/output/punch_ue_t1"
...
do 
  ...
  cd ../utils
  python3 tensorflow_rename_variables.py --checkpoint_dir=${target_file_full} --replace_from=punch_ue_t1 --replace_to=${target_file_part}
  cd ../network
