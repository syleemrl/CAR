...
target_file="/home/sonic/Projects/CAR/network/output/punch_ue_t${visit}${explore}${egreedy}"
...
do 
  ...
  cd ../network
  python3 ppo.py --parametric --adaptive --ref=punch_ue.bvh --test_name=${target_file_part} --pretrain="${target_file_full}/network-0" --nslaves=8 --explore=${explore} --visit=${visit} --egreedy=${egreedy} --exploration_test_print=${print_file}
