#ifndef __VMCON_SEQ_REC_WINDOW_H__
#define __VMCON_SEQ_REC_WINDOW_H__
#include "Camera.h"
...
class SeqRecordWindow : public GUI::GLUTWindow
{
public:
	/// Constructor.
...
protected:
	...
	std::vector<int> mEndKeyFrame;
	std::vector<Eigen::VectorXd> mMemoryRef;
	std::vector<Eigen::Vector3d> mMemoryKey;
	std::vector<Eigen::Vector3d> mMemoryTarget;
	DPhy::Character* mRef;
};
