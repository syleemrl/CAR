...
namespace GUI
{
	...
	void DrawPoint(const Eigen::Vector3d& p0,const Eigen::Vector3d& color = Eigen::Vector3d(0.8,0.8,0.8), const double scale = 1.0);
	...
	void DrawTrajectory(const std::vector<Eigen::Vector3d> points, const int idx, const Eigen::Vector3d& color = Eigen::Vector3d(1.0,0.0,0.0), bool line=true, bool bezier=true);
